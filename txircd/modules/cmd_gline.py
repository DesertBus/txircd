			...
			for uid, reason in now_banned.iteritems():
				...
				for chan in leavingChans:
					...
					for u in cdata.users:
						quit_to.add(u)
				for u in quit_to:
					u.sendMessage("QUIT", ":G:Lined: {}".format(reason), to=None, prefix=udata.prefix())
				udata.sendMessage("ERROR", ":Closing Link {} [G:Lined: {}]".format(udata.prefix(), data["reason"]), to=None, prefix=None)
